...
class Control:
    ...
    def setLegAngle3rdGaitMode(self):
        if self.checkPoint():
            for i in range(6):
                self.angle[i][0],self.angle[i][1],self.angle[i][2]=self.coordinateToAngle(-self.leg_point[i][2],
                                                                                          self.leg_point[i][0],
            ...
            self.servo.setServoAngle(16,100) #orignal 90, 92, 93, 94,
            self.servo.setServoAngle(17,10)
            self.servo.setServoAngle(18,10)
            #self.servo.setServoAngle(16,self.angle[5][0]) #orignal 90, 92, 93, 94,
            #self.servo.setServoAngle(17,self.angle[5][1]) #orignal 31, 35, 37, 39, 42, 50, 59, 58, 57 back down
            #self.servo.setServoAngle(18,self.angle[5][2]) #orignal 58, 59, 62, 65, 70, 71, 74, 73, 72, 71
